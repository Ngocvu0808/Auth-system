...
import com.ttt.mar.auth.dto.app.ClientUserPermissionDto;
...
import com.ttt.mar.auth.entities.enums.ClientApiStatus;
import com.ttt.mar.auth.entities.enums.ClientAuthType;
import com.ttt.mar.auth.entities.enums.ClientServiceStatus;
import com.ttt.mar.auth.entities.enums.ClientStatus;
import com.ttt.mar.auth.entities.enums.HttpStatusCustom;
...
import com.ttt.mar.auth.filter.ClientApiFilter;
import com.ttt.mar.auth.filter.ClientApiKeyFilter;
import com.ttt.mar.auth.filter.ClientUserFilter;
import com.ttt.mar.auth.filter.RequestLogClientFilter;
import com.ttt.mar.auth.filter.ServiceFilter;
import com.ttt.mar.auth.mapper.AccessTokenMapper;
import com.ttt.mar.auth.mapper.ClientApiKeyMapper;
import com.ttt.mar.auth.mapper.ExternalApiMapper;
import com.ttt.mar.auth.mapper.LogRequestMapper;
import com.ttt.mar.auth.mapper.RefreshTokenMapper;
import com.ttt.mar.auth.mapper.RoleMapper;
import com.ttt.mar.auth.mapper.ServiceMapper;
import com.ttt.mar.auth.mapper.UserClientMapper;
import com.ttt.mar.auth.repositories.AccessTokenRepository;
import com.ttt.mar.auth.repositories.ApiKeyRepository;
import com.ttt.mar.auth.repositories.ApiRequestRepository;
...
import com.ttt.mar.auth.repositories.ClientServiceRepository;
import com.ttt.mar.auth.repositories.ClientUserPermissionRepository;
import com.ttt.mar.auth.repositories.ClientUserRepository;
import com.ttt.mar.auth.repositories.ExternalApiRepository;
import com.ttt.mar.auth.repositories.LogRequestRepositoryExtended;
import com.ttt.mar.auth.repositories.RoleDetailRepositoryExtended;
import com.ttt.mar.auth.repositories.ServiceRepository;
import com.ttt.mar.auth.service.iface.ApplicationService;
import com.ttt.mar.auth.utils.DateUtil;
...
public class ApplicationServiceImpl implements ApplicationService {
  ...
  private final LogRequestRepositoryExtended logRequestRepository;
  ...
  public ApplicationServiceImpl(ClientRepository clientRepository,
      ...
      LogRequestRepositoryExtended logRequestRepository,
  ...
  public void updateStatusOfAccessToken(AccessTokenStatusRequestDto dto, Integer userId)
    ...
    if (dto.getStatus().equals(TokenStatus.REJECTED)) {
      // remove key redis
      String redisKey = RedisKey.AUTH_TOKEN.concat(accessTokenById.getToken()).trim();
  ...
  public void addService(Integer clientId, ClientServiceAddDto dto, Integer creatorId)
    ...
    Optional<com.ttt.mar.auth.entities.service.Service> serviceOptional = serviceRepository
  ...
  public List<CustomServiceDto> getServices(Integer clientId) throws ResourceNotFoundException {
    ...
    List<com.ttt.mar.auth.entities.service.Service> serviceList = clientServiceList.stream()
  ...
  public CustomServiceDto getService(Integer clientId, Integer serviceId)
    ...
    com.ttt.mar.auth.entities.service.Service service = serviceOptional.get();
  ...
  public void addApi(Integer clientId, ClientApiAddDto dto, Integer creatorId)
    ...
    com.ttt.mar.auth.entities.service.Service service = externalApi.getService();
  ...
  public DataPagingResponse<ServiceResponseDto> getListServiceNotSettingOnApp(
    ...
    Set<Integer> serviceIds = clientServices.stream()
        ...
        .collect(Collectors.toSet());
    Specification<com.ttt.mar.auth.entities.service.Service> specification = new ServiceFilter()
        .getServiceFilter(search, listSystemId, serviceIds, map, ServiceStatus.ACTIVE, false);
    Page<com.ttt.mar.auth.entities.service.Service> servicePage = serviceRepository
        .findAll(specification, PageRequest.of(page - 1, limit));
    List<com.ttt.mar.auth.entities.service.Service> serviceList = servicePage.getContent();
  ...
  public String createApiKey(Integer clientId, Integer userId)
    ...
    if (!listClientApiKeyActive.isEmpty()) {
      listClientApiKeyActive.forEach(it -> {
        ...
        String key = RedisKey.AUTH_APP.concat(it.getApiKey());
  ...
  public void deleteApiKey(Integer id, Integer userId)
    ...
    String redisKey = RedisKey.AUTH_APP.concat(apiKey.getApiKey());
    if (redisService.exists(redisKey)) {
      redisService.remove(redisKey);
    }
  }
