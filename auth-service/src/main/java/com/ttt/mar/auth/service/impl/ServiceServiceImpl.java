...
import com.ttt.mar.auth.filter.ApiFilter;
import com.ttt.mar.auth.filter.ApiRequestFilter;
import com.ttt.mar.auth.filter.ServiceFilter;
import com.ttt.mar.auth.mapper.ApiRequestMapper;
...
import com.ttt.mar.auth.repositories.ServiceTagRepository;
...
public class ServiceServiceImpl implements ServiceService {
  ...
  public Integer createService(ServiceRequestDto serviceRequestDto, Integer userId)
    ...
    com.ttt.mar.auth.entities.service.Service service = serviceMapper
        .fromServiceRequestDto(serviceRequestDto);
    service.setSystem(optionalSystemById.get());
    service.setStatus(ServiceStatus.ACTIVE);
    service.setCreatorUser(user);

    com.ttt.mar.auth.entities.service.Service serviceSaved = serviceRepository.save(service);
  ...
  public Boolean updateStatusService(ServiceRequestUpdateStatusDto serviceRequestUpdateStatusDto,
    ...
    com.ttt.mar.auth.entities.service.Service serviceById = serviceRepository
  ...
  public List<ServiceResponseDto> getAll() {
    List<com.ttt.mar.auth.entities.service.Service> services = serviceRepository
  ...
  public void addTagToService(ServiceRequestDto serviceRequestDto,
      com.ttt.mar.auth.entities.service.Service service) throws ResourceNotFoundException {
  ...
  public DataPagingResponse<ServiceResponseDto> getServices(String systems, String status,
    ...
    Page<com.ttt.mar.auth.entities.service.Service> pageService = serviceRepository
